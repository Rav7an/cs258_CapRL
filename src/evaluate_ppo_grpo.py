...
OUTPUT_REPORT_JSON = "evaluation_report_ppo_grpo.json"
OUTPUT_REPORT_MD = "analysis_summary_ppo_grpo.md"
...
EVAL_SAMPLES = 2000  # Number of samples to evaluate per model (set to None for full dataset)
